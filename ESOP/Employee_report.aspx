<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="Employee_report.aspx.cs" Inherits="ESOP.Employee_report" %>
                ...
                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body mr-4">
                            <div class="row" style="margin-top: 55px;margin-left:270px;">
                                <div class="col-12 col-sm-12 col-lg-4">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="employee-exercise-report.aspx">
                                                <div class="profile-widget-name">Exercise Report</div>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-lg-4">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="employee-sale-report.aspx">
                                                <div class="profile-widget-name">Sale Report</div>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card profile-widget" style="height: 65%;">
                                       <div class="profile-widget-header">
                                          <div class="row">
                                             <div class="col-12">
                                                <div class="feature-rounded">
                                                   <img alt="image" src="assets/img/refresh (1).png" class="" style="background: #2600ff  !important;">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="profile-widget-description pb-0">
                                          <a href="grant-correction.html"><div class="profile-widget-name"><span class="notification-count bg-info" style="color:white;padding: 1px 10px;font-size:16px;padding-top: 7px;">10</span>Correction of Rejected Grant</div></a>
                                       </div>
                                    </div>
                                 </div> -->
                            </div>
