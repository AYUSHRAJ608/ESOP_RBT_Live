<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="PresidentsGrantApproval_Report.aspx.cs" EnableEventValidation="false" Inherits="ESOP.PresidentsGrantApproval_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        //$('#ContentPlaceHolder1_gvParent').clear().draw();
        $(function () {
            var prm = Sys.WebForms.PageRequestManager.getInstance();

            prm.add_endRequest(function (sender, e) {

                $('#ContentPlaceHolder1_gvParent').dataTable({
    ...
    <div class="main-content" style="padding-top: 55px; padding-left: 40px; padding-right: 10px;">
        <div style="font-weight: 500; display: none" runat="server" id="div">Employee Grant Approval Summary</div>
        <nav aria-label="breadcrumb">

            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a id="dasboard" runat="server" href="president-dashboard.aspx">Home</a></li>
                <li class="breadcrumb-item"><a id="report" runat="server" href="President_report.aspx">Reports</a></li>
                <li class="breadcrumb-item active" aria-current="page" runat="server" id="li">President Grant Approval</li>
            </ol>
        </nav>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Employee Grant Approval Summary</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="table-responsive" style="margin-top: 30px;">
                                <asp:UpdatePanel ID="upd" runat="server" UpdateMode="Conditional">
                                    ...
                                    <ContentTemplate>
                                        <asp:GridView ID="gvParent" runat="server" OnRowDataBound="gvParent_RowDataBound" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true"
                                            CssClass="table table-bordered simple-tree-table" DataKeyNames=""
                                            ...
                                            <Columns>
                                                        ...
                                                        <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                                            <asp:GridView ID="gvChild" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered simple-tree-table"
                                                                ...
                                                                <Columns>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Panel ID="pnlOrders1" runat="server" Style="display: none">
                                                                                <asp:GridView ID="gvSubChild" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered simple-tree-table"
                                                                                    Style="border-collapse: separate; border-spacing: 4px;" ShowHeader="true">
                                                                                    <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderStyle-Width="95%" ItemStyle-Width="95%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" ItemStyle-BackColor="#e8f4f8"
                                                                        ItemStyle-ForeColor="#03a4c8" ItemStyle-CssClass="griditem">
                                                                        <ItemTemplate>
                                                                            <div style="text-align: left;">
                                                                                <asp:Label runat="server" ID="lblTranchName" Text='<%#Eval("GRANT_NAME") %>' Style="text-align: left;"></asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="Manager Name" HeaderStyle-CssClass="text-nowrap" HeaderStyle-Font-Bold="true" HeaderStyle-Width="12%" ItemStyle-CssClass="griditem1">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HiddenField ID="HdEmpCode" Visible="false" runat="server" Value='<%# Bind("ECODE") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:BoundField DataField="VESTED" HeaderStyle-Font-Bold="true" HeaderText="Vested" HeaderStyle-Width="8%">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="VESTED_PENDING" HeaderStyle-Font-Bold="true" HeaderText="Pending for Vesting" HeaderStyle-Width="8%">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="EXERCISED" HeaderStyle-Font-Bold="true" HeaderText="Exercised" HeaderStyle-Width="8%">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="EXERCISED_PENDING" HeaderStyle-Font-Bold="true" HeaderText="Pending for Excercise" HeaderStyle-Width="8%">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="SALE" HeaderStyle-Font-Bold="true" HeaderText="Sell" HeaderStyle-Width="8%">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="LBV" HeaderStyle-Font-Bold="true" HeaderText="LBV" HeaderStyle-Width="6%">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="LAV" HeaderStyle-Font-Bold="true" HeaderText="LAV" HeaderStyle-Width="6%">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="TOTAL_LAPSE" HeaderStyle-Font-Bold="true" HeaderText="Total Lapsed" HeaderStyle-Width="8%">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="STOCK_IN_HAND" HeaderStyle-Font-Bold="true" HeaderText="Stock in Hand" HeaderStyle-Width="8%">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="ECode" HeaderStyle-Font-Bold="true" HeaderText="ECode" HeaderStyle-Width="8%">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="EMP_NAME" HeaderStyle-Font-Bold="true" HeaderText="EMP NAME" HeaderStyle-Width="8%">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="BANDS" HeaderStyle-Font-Bold="true" HeaderText="BANDS" HeaderStyle-Width="8%">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="LOCATION" HeaderStyle-Font-Bold="true" HeaderText="LOCATION" HeaderStyle-Width="8%">
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                                </asp:BoundField>
                                            </Columns>
                                        </asp:GridView>
