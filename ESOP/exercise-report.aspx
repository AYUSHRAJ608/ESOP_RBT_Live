<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="exercise-report.aspx.cs" Inherits="ESOP.exercise_report" EnableEventValidation="false" %>
        ...
        <nav aria-label="breadcrumb">
            <div id="shownav1" runat="server">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Exercise Report</li>
                </ol>
            </div>

            <div id="shownav" runat="server">
                <ol class="breadcrumb" style="margin-left: 0px;">
                    <li class="breadcrumb-item"><a href="Employee-secretarial.aspx">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Exercise Report</li>
                </ol>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive" style="margin-top: 5%">
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                    <ContentTemplate>
                                        <asp:GridView ID="gvExercise" runat="server" AutoGenerateColumns="False" PageSize="25" ShowHeaderWhenEmpty="false" OnRowDataBound="gvExercise_RowDataBound"
                                            class="table table-striped table-hover" DataKeyNames="ID" EmptyDataText="No Records Found" OnRowCommand="gvExercise_RowCommand" OnPreRender="gvExercise_PreRender">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="VESTING_DETAIL_CODE" HeaderText="Vesting Code" HeaderStyle-Width="" />
                                               ...
                                               <%-- <asp:BoundField DataField="AMOUNT_DEPOSITED" HeaderText="Total Amount Deposited" HeaderStyle-Width="" />
                                                ...
                                                <asp:BoundField DataField="loan_amount" HeaderText="Total Amount Deposited" HeaderStyle-Width="" />
                                                <asp:BoundField DataField="loan_margin_amount" HeaderText="Funding Amount" HeaderStyle-Width="" />
                                                <asp:BoundField DataField="total_amount" HeaderText="Total Deposited" HeaderStyle-Width="" />
                                                ...
                                                <asp:TemplateField HeaderText="Document Type">
                                                    <ItemTemplate>
                                                        <div class="btn-group">
                                                            ...
                                                            &nbsp;
                                                            <asp:LinkButton ID="btn_Preview" runat="server" CommandName="Preview" CausesValidation="false" CssClass="btn btn-icon btn-primary fas fa-eye edit12"></asp:LinkButton>
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                        ...
                                        <asp:GridView ID="gvExercise_dummy" runat="server" AutoGenerateColumns="False" PageSize="25" ShowHeaderWhenEmpty="false"
                                            class="table table-striped table-hover" DataKeyNames="ID" EmptyDataText="No Records Found" OnRowCommand="gvExercise_RowCommand" OnPreRender="gvExercise_PreRender" Style="display: none">
                                            <Columns>
