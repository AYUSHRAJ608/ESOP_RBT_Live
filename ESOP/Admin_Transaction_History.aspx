<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="Admin_Transaction_History.aspx.cs" Inherits="ESOP.Admin_Transaction_History" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.CloseBtnNew').click(function () {
                ...
                $("#my_Grant_Corr_Modal").removeClass("show");
                $("#my_Grant_Corr_Modal").hide();

                $("#my_Vesting_Modal").removeClass("show");
                $("#my_Vesting_Modal").hide();
    ...
    <div class="main-content" style="padding-top: 55px; padding-left: 40px; padding-right: 10px;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12 table-responsive" style="margin-bottom: 0; padding-top: 15px;">
                                <asp:GridView ID="GrvGrantMain" runat="server" AutoGenerateColumns="false" OnPreRender="GrvGrantMain_PreRender"
                                    CssClass="table table-bordered simple-tree-table" DataKeyNames="grant_name" OnRowDataBound="GrvGrantMain_RowDataBound"
                                                    ...
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:GridView ID="GrvPendingforApproval" runat="server" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" PageSize="10"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Audit Trail" HeaderStyle-Width="2%">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Audit" CausesValidation="true"
                                                                            CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                                                            CssClass="fas fa-info edit12"></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                ...
                                                <asp:Panel ID="Panel1" runat="server" Style="display: none">
                                                    <asp:GridView ID="grdmain_1_Child" runat="server" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" PageSize="25"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="Pending" HeaderText="Pending No of Options" HeaderStyle-Width="10%" />
                            ...
                            <div class="col-md-12 table-responsive" style="margin-bottom: 0; padding-top: 15px;">
                                <asp:GridView ID="grdMain2" runat="server" AutoGenerateColumns="false" OnPreRender="grdMain2_PreRender"
                                    ...
                                    Style="border-collapse: separate;" EmptyDataText="" EmptyDataRowStyle-CssClass="Empty">
                                    <%--"ID,ECODE,SALE_OFFER_FILE_PATH,SALE_DECLARATION_FILE_PATH,SALE_TRANSACTION_RECEIPT_FILE_PATH"--%>
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-Width="3%">
                                            <ItemTemplate>
                                                <img alt="" style="cursor: pointer" src="assets/img/plus.svg" height="25px" width="25px" />
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:GridView ID="GrvPendingforApproval_2" runat="server" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" PageSize="10"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Sale Price FMV" HeaderStyle-Width="10%">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:BoundField DataField="Pending" HeaderText="Stock in Hand" HeaderStyle-Width="5%" />
                                                                <asp:TemplateField HeaderText="Amount Received" HeaderStyle-Width="15%">
                                                                    <ItemTemplate>
        ...
        <div class="modal bd-example-modal-lg" id="my_Grant_Corr_Modal" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-xl boxModalDiv">
                ...
                <div class="modal-content" style="width: 100%;">
                    <div class="modal-header"><%--<button type="button" class="close CloseBtnNew" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span></button>--%>
                        <h5 class="modal-title" id="myLargeModalLabel_1">Audit Trail
                            <%--<button type="button" class="close" data-dismiss="modal">×</button>--%>
                            <%--<a href="#" class="btn btn-info btn-lg all" data-dismiss="modal">×</a>--%>
                        </h5>
                    </div>
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="grdData" class="table" runat="server" Style="width: 98%;"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="grant_name" HeaderText="Grant Name" HeaderStyle-Width="9%" />
                                            <asp:BoundField DataField="date_of_grant" HeaderText="Date of Grant" HeaderStyle-Width="9%" />
                                            <asp:BoundField DataField="Employee_Id" HeaderText="Employee Name" HeaderStyle-Width="9%" />
                                            <asp:BoundField DataField="no_of_options" HeaderText="No of Options" HeaderStyle-Width="9%" />
                                            <asp:BoundField DataField="remark1" HeaderText="PR Remark" HeaderStyle-Width="9%" />
                                            <asp:BoundField DataField="remark2" HeaderText="HR Remark" HeaderStyle-Width="9%" />
                                            <asp:BoundField DataField="ADMIN_GRANT_CORRECTION_REJECTION_REMARK" HeaderText="Admin Remark" HeaderStyle-Width="9%" />
                                            <asp:BoundField DataField="creation_date" HeaderText="Created Date" HeaderStyle-Width="9%" />
                                            <asp:BoundField DataField="created_by" HeaderText="Created By" HeaderStyle-Width="9%" />
                                            <asp:BoundField DataField="updated_date" HeaderText="Updated Date" HeaderStyle-Width="9%" />
                                            <asp:BoundField DataField="updated_by" HeaderText="Updated By" HeaderStyle-Width="9%" />
                                            <asp:BoundField DataField="Status" HeaderText="Status" HeaderStyle-Width="9%" />
                                            <asp:BoundField DataField="Proxy" HeaderText="Proxy" HeaderStyle-Width="9%" />
            ...
            <div class="modal-dialog modal-xl boxModalDiv">
                ...
                <div class="modal-content" style="width: 100%;">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myLargeModalLabel_2">Audit Trail
                            <%--<button type="button" class="close" data-dismiss="modal">×</button>--%>
                                    ...
                                    <asp:GridView ID="grdData_1" class="table" runat="server" Style="width: 98%;" OnPreRender="grdData_1_PreRender"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Vesting Code">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server" Text='<%#Eval("Vest_Code") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Updated Date">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="Label2" runat="server" Text='<%#Eval("modifieddate") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Proxy">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="Label5" runat="server" Text='<%#Eval("proxy") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
        ...
        <div class="modal bd-example-modal-lg" id="my_Exercise_Modal" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-xl boxModalDiv">
                ...
                <div class="modal-content" style="width: 100%;">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myLargeModalLabel_3">Audit Trail
                            <%--<button type="button" class="close" data-dismiss="modal">×</button>--%>
                        </h5>
                    </div>
        ...
        <div class="modal bd-example-modal-lg" id="my_Sale_Modal" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-xl boxModalDiv">
                ...
                <div class="modal-content" style="width: 100%;">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myLargeModalLabel_4">Audit Trail
                            <%--<button type="button" class="close" data-dismiss="modal">×</button>--%>
                        </h5>
                    </div>
    ...
    <script type="text/javascript">
        function openModalShowGrantAudit() {
