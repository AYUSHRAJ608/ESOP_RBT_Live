<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="Checker_Approve_Reject.aspx.cs" Inherits="ESOP.Checker_Approve_Reject" EnableEventValidation="false" %>
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <asp:GridView ID="grdpendingapproval" runat="server" OnPreRender="grdpendingapproval_PreRender" EmptyDataText="" ShowHeaderWhenEmpty="false"
                                                    AutoGenerateColumns="False" class="table" DataKeyNames="GRANT_ID,ecode,GRANT_NAME,fmv_price" OnRowCommand="grdpendingapproval_RowCommand">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                        ...
                                                        <asp:BoundField HeaderText="Emp ID" DataField="ecode" SortExpression="ecode" />
                                                        ...
                                                        <asp:BoundField HeaderText="Grant Date" DataField="date_of_grant" SortExpression="date_of_grant" />
                                                        <asp:BoundField HeaderText="Total Grant" DataField="no_of_options" SortExpression="no_of_options" HeaderStyle-Width="5%" />
                                                            ...
                                                            <ItemTemplate>
                                                                <div class="remark">
                                                                    <asp:TextBox ID="txtremark" runat="server" placeholder="Enter Remark" TextMode="MultiLine" onKeyUp="javascript:Count(this);"
                                                                        onChange="javascript:Count(this);" Width="90"></asp:TextBox>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action">
                                                            <ItemTemplate>
                                                                ...
                                                                <div class="btn-group">
                                                                    <asp:Button ID="btn_Approve" runat="server" CommandName="Approve" CausesValidation="false" OnClick="btn_Approve_Click" OnClientClick="return validateCheckBoxesapprove();"
