...
namespace ESOP
{
    public partial class Secretarial_Dashboard : System.Web.UI.Page
    {
        ...
        private DataTable CalculateTotal(DataTable dt)
        {
            ...
            try
            {
                ...
                newdt.Columns.Add("LAPSE_DATE");      //Added by Rahul on 22-08-22 for Showing lapse date on dashboard
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    dr1["LAPSE_DATE"] = dt.Rows[i]["lapse_date"].ToString();          //Added by Rahul on 22-08-22 for Showing lapse date on dashboard
                    newdt.Rows.Add(dr1);
