<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="Employee-secretarial.aspx.cs" Inherits="ESOP.Employee_secretarial" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="main-content">
        <section class="section">
                                    ...
                                    <table class="table table-borderless click" style="margin-bottom: 0px;">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 15%"><a class="nav-link" runat="server" id="lnkBank_Statement" onserverclick="lnkBank_Statement_ServerClick">Bank Statement
                                                </a></td>
                                                <td style="text-align: left">
                                                    <a class="nav-link" runat="server" id="lnkExcercise_Report" onserverclick="lnkExcercise_Report_ServerClick">Exercise Report</a></td>
                ...
                <div class="col-12">
                    <div class="card" style="height: 100%;">
                        <div class="card-header">
                            <h4>Secretarial Approval Summary</h4>
                        ...
                        <div class="card-body">
                            <ul class="offset-md-4 nav nav-pills" id="myTab3" role="tablist">
                                ...
                                <%-- <li class="nav-item">
                                    <a class="nav-link" id="contact-tab3" data-toggle="tab" href="#contact3" role="tab" aria-controls="contact" aria-selected="false">Rejected</a>
                                </li>--%>
                            </ul>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-Width="3%">
                                                            ...
                                                            <ContentTemplate>--%>
                                                                    <asp:GridView ID="GrvPendingforApproval" runat="server" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" PageSize="25"
                                                                        class="table" EmptyDataText="No Records Found" DataKeyNames="EETDID,GRANT_ID,EXERCISE_TRAN_ID,vesting_detail_id,ecode" 
                                                                        EnableViewState="false" OnRowCommand="GrvPendingforApproval_RowCommand">
                                                                        <Columns>
                                                                            <asp:TemplateField>
                                                                                <HeaderTemplate>
            ...
            <div style="display: none" runat="server">
                <asp:GridView ID="GrdData" runat="server" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" PageSize="25"
                    class="table" EmptyDataText="No Records Found" DataKeyNames="EETDID,GRANT_ID,EXERCISE_TRAN_ID,vesting_detail_id,ecode" EnableViewState="false" OnRowCommand="GrvPendingforApproval_RowCommand">
                    <Columns>
