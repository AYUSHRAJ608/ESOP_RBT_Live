<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LetterList_Type.aspx.cs" Inherits="ESOP.LetterList_Type" MasterPageFile="~/ESOP.Master" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.CloseBtnNew').click(function () {
                ...
                <%--if (document.getElementById('<%=txtfuNEFT1.ClientID %>').value == 'file') {--%>
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-content">
                <nav aria-label="breadcrumb" class="offset-md-9">
                    <ol class="breadcrumb" style="margin-left: -30%;">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <ul class="nav nav-pills offset-md-8" id="myTab4" role="tablist">
                                ...
                                <div class="card-body">
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="home4" role="tabpanel" aria-labelledby="home-tab4">
                                            <div class="table-responsive" style="margin-bottom: 0; padding-top: 15px;" role="tab">
                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                    <ContentTemplate>
                                                        <asp:GridView ID="GrvLetter_List" runat="server" AutoGenerateColumns="False"
                                                            class="table table-bordered" EmptyDataText="No Records Found" OnRowCommand="GrvLetter_List_RowCommand"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="GRANT_DATE" HeaderText="Grant / Sale Date" />
                                                                ...
                                                                <asp:TemplateField HeaderText="Action">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:LinkButton ID="lb_download" runat="server" CommandName="download" CausesValidation="false"
                                                                            class="btn btn-icon btn-primary fas fa-arrow-down" CommandArgument='<%# Eval("FILENAME") %>'></asp:LinkButton>
                                                                        <%--OnClick="lb_download_Click"--%>
                                                                        <span>
                                                                            <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Bind("FILENAME") %>' />
                                                                            <asp:LinkButton ID="btn_Preview" runat="server" CausesValidation="false" CommandName="Preview"
                                                                                CssClass="btn btn-icon btn-success fas fa-eye" CommandArgument='<%# Eval("FILENAME") %>'></asp:LinkButton>
                                                    ...
                                                    <%-- <Triggers>
                                                        <asp:PostBackTrigger ControlID="GrvLetter_List" />
                                                    </Triggers>--%>
                                                </asp:UpdatePanel>
                                        ...
                                        <div class="tab-pane fade" id="profile4" role="tabpanel" aria-labelledby="profile-tab4">
                                            <div>
                                                <ul class="offset-md-4 nav nav-pills" id="myTab3" role="tablist">
                                                    ...
                                                    <%--<li class="nav-item">
                                            <a class="nav-link" id="contact-tab3" data-toggle="tab" href="#contact3" role="tab" aria-controls="contact" aria-selected="false">Vesting</a>
                                          </li>--%>
                                                    <li class="nav-item">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer bg-whitesmoke br">
                            <asp:CheckBox ID="CheckBox1" runat="server" ClientIDMode="Static"/>
                                <asp:Label ID="Label1" runat="server" Text="Label" style="margin-right:545px">I acknowledge the same.</asp:Label>
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <a class="btn btn-info btn-lg all CloseBtnNew" data-dismiss="modal" runat="server" autopostback="true">Close</a>
                                
                                <%--<asp:TextBox ID="txtfuNEFT1" runat="server" ></asp:TextBox> 
                                ...
                                <asp:CheckBox ID="checkAll" runat="server" onclick="checkAll();" />--%>
