<%@ Page Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="Admin_Details_Approve_Reject.aspx.cs" Inherits="ESOP.Admin_Details_Approve_Reject" %>
                    ...
                    <div class="card" style="height: 100%;">
                        <div class="card-header">
                            ...
                            <div class="offset-md-7 buttons" style="margin-left: 56.333333%" id="showhidebtn">
                                <asp:Button ID="btn_BulkApprove" runat="server"  CausesValidation="false"
                                    Text="Bulk Approve" CssClass="btn badge badge-success badge-shadow" OnClick="btn_bulkApprove_Click"></asp:Button>
                                <asp:Button ID="btn_BulkReject" runat="server" CausesValidation="false"
                                    Text="Bulk Reject" CssClass="btn badge badge-danger badge-shadow" OnClick="btn_bulkReject_Click"></asp:Button>
                            </div>
                        ...
                        <div class="card-body">
                            <ul class="offset-md-4 nav nav-pills" id="myTab3" role="tablist">
                                ...
                                <asp:ImageButton ID='btnexcelExport' runat='server' ImageUrl="~/img/excel1.png" Style="margin-left: 20px !important; display: none"  Height="35px" ToolTip="Export To Excel" />
                            </ul>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-Width="3%">
                                                            ...
                                                            <ContentTemplate>--%>
                                                                    <asp:GridView ID="GrvPendingforApproval" runat="server" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" PageSize="25"
                                                                        class="table" EmptyDataText="No Records Found" OnRowCommand="GrvPendingforApproval_RowCommand" DataKeyNames="EETDID,GRANT_ID,EXERCISE_TRAN_ID,vesting_detail_id,ecode" EnableViewState="false" >
                                                                        <Columns>
                                                                            <asp:TemplateField>
                                                                                <HeaderTemplate>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Action" HeaderStyle-Width="10%">
                                                                                <ItemTemplate>
                                                                                    <div class="btn-group">
                                                                                        ...
                                                                                        <asp:Button ID="btnApprove" Text="Approve" runat="server" CausesValidation="false" 
                                                                                            CssClass="btn badge badge-success badge-shadow" CommandName="Approve"></asp:Button>

                                                                                        <asp:Button ID="btnReject" Text="Reject" runat="server" 
                                                                                            CssClass="btn badge badge-danger badge-shadow" CommandName="Reject"></asp:Button>
                                                                                    </div>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="GrvReject" runat="server" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" PageSize="25"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="dpid" HeaderText="DP ID" HeaderStyle-Width="5%" />
                                                        <asp:BoundField DataField="client_id" HeaderText="Client ID" HeaderStyle-Width="5%" />
                                                        <asp:BoundField DataField="member_type" HeaderText="Member Type" HeaderStyle-Width="10%" />
                ...
                <ContentTemplate>
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="padding-left: 15px; padding-right: 15px;">
                            ...
                            <div class="row popRow aligncenter" runat="server" id="DivImage1" style="display: none">
                                <img id="FreshDEMATImage1" runat="server" height="200" width="600" />
                            </div>
                            <div class="row popRow aligncenter" runat="server" id="Div1" style="display: none">
                                <embed runat="server" id="embed2" width="100%" height="500" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html" />
                            </div>
                        </div>
