<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="Admin_Exercise_Cancel.aspx.cs" Inherits="ESOP.Admin_Exercise_Cancel" %>
    ...
    <div class="main-content">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Exercise Revert</li>
            </ol>
        </nav>
                ...
                <div class="col-12">
                    <div class="card" style="height: 100%;">
                        <div class="card-header">
                            <h4>Admin Execrcise Revert Summary</h4>
                        ...
                        <div class="card-body">
                            <ul class="offset-md-4 nav nav-pills" id="myTab3" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab3" data-toggle="tab" href="#home3" role="tab" aria-controls="home" aria-selected="true">Pending Revert</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab3" data-toggle="tab" href="#profile3" role="tab" aria-controls="profile" aria-selected="false">Reverted</a>
                                </li>
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <asp:GridView ID="GrvPendingforApproval" runat="server" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" PageSize="25"
                                                    class="table" EmptyDataText="No Records Found" DataKeyNames="ECODE,ENAME,Grant_Name,Vesting_Detail_Code,Exercise_Tran_Id,Total_Vesting,EXERCISE_PENDING,Total_Exercise_Approved" EnableViewState="false">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                        ...
                                                        <asp:BoundField DataField="ENAME" HeaderText="Employee Name" HeaderStyle-Width="10%" />
                                                        <asp:BoundField DataField="Grant_Name" HeaderText="Grant_Name" />
                                                        <asp:BoundField DataField="Vesting_Detail_Code" HeaderText="Vesting Details Code"  HeaderStyle-Width="8%" />
                                                        
                                                        <asp:TemplateField HeaderText="Exercise Transacation ID" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblno_of_exercise" runat="server" Text='<%# Bind("Exercise_Tran_Id") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="Total_Vesting" HeaderText="Total Vesting"  HeaderStyle-Width="9%" />
                                                        <asp:BoundField DataField="EXERCISE_PENDING" HeaderText="EXERCISE_PENDING"  HeaderStyle-Width="8%"/>
                                                        <%--<asp:BoundField DataField="grant_price" HeaderText="Grant Price" HeaderStyle-Width="7%" />--%>
                                                        
                                                        <asp:BoundField DataField="Total_Exercise_Approved" HeaderText="Total_Exercise_Approved" HeaderStyle-Width="5%" />
                                                        ...
                                                        <%-- Added by Bhushan on 02-02-23 for Tax Master CR--%>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action" HeaderStyle-Width="10%">
                                                            <ItemTemplate>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <%--<asp:LinkButton ID ="lnkbtnApprove" runat ="server" CommandName ="Approve" ></asp:LinkButton>--%>
                                                                    <asp:Button ID="btnRevert" Text="Revert" runat="server" CausesValidation="false" CommandName="Revert"
                                                                        CssClass="btn badge badge-success badge-shadow" OnClick="btnRevert_Click"></asp:Button>
                                        ...
                                        <asp:UpdatePanel ID="updpnl2" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="GrvApproved" runat="server" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" PageSize="25"
                                                     class="table" EmptyDataText="" AllowPaging="false" AllowSorting="false">
                                                    <Columns>
                                                        <asp:BoundField DataField="ECODE" HeaderText="Employee Code" HeaderStyle-Width="10%" SortExpression="ecode" />
                                                        <asp:BoundField DataField="ENAME" HeaderText="Employee Name" HeaderStyle-Width="12%" SortExpression="emp_name" />
                                                        
                                                        <asp:BoundField DataField="Grant_Name" HeaderText="Grant Name" SortExpression="GRANT_NAME" />
                                                        <asp:BoundField DataField="Vesting_Detail_Code" HeaderText="Vesting_Detail_Code"  HeaderStyle-Width="9%" SortExpression="Vesting_Detail_Code" />
                                                        <asp:TemplateField HeaderText="Vesting Details ID" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblno_of_exercise" runat="server" Text='<%# Bind("Exercise_Tran_Id") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="Total_Vesting" HeaderText="Total_Vesting" HeaderStyle-Width="5%" />
                                                        <asp:BoundField DataField="EXERCISE_PENDING" HeaderText="EXERCISE_PENDING" HeaderStyle-Width="5%" />
                                                        <asp:BoundField DataField="Total_Exercise_Approved" HeaderText="Total_Exercise_Approved" HeaderStyle-Width="5%" />
                                                       
                                                        
                                                         <asp:BoundField DataField="Remark" HeaderText="Remark" HeaderStyle-Width="5%" />
                                                        <asp:BoundField DataField="Status" HeaderText="Status" HeaderStyle-Width="5%" />
                                                       
                                                        <asp:BoundField DataField="Reverted_Date" HeaderText="Reverted Date" HeaderStyle-Width="10%" />
