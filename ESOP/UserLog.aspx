<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="UserLog.aspx.cs" Inherits="ESOP.UserLog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="main-content">
        <%-- <div style="font-weight: 500;">User Log</div>--%>
                                ...
                                <asp:UpdatePanel ID="upd" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:GridView ID="grdapproval" runat="server" ShowHeaderWhenEmpty="false"
                                            OnPreRender="grdapproval_PreRender" OnRowCommand="grdapproval_RowCommand" EmptyDataText="No Records Found" AutoGenerateColumns="false"
                                            class="table" DataKeyNames="ecode">
                                            <Columns>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="grdData" class="table table-striped table-hover" runat="server" Style="width: 98%;" OnPreRender="grdData_PreRender"
                                    AutoGenerateColumns="False" AllowPaging="false" AllowSorting="false" PageSize="10" OnPageIndexChanging="grdData_PageIndexChanging"
                                    EmptyDataText="No data found" AllowCustomPaging="false" ViewStateMode="Enabled">
                                    <Columns>


                                        <asp:BoundField HeaderText="Employee Name" DataField="Emp_Name" SortExpression="Emp_Name" />
                                        <asp:BoundField HeaderText="Employee Status" DataField="Estatus" SortExpression="Estatus" />
                                        <asp:BoundField HeaderText="Modified By" DataField="EM_MODIFIED_BY" SortExpression="EM_MODIFIED_BY" />
                                        <asp:BoundField HeaderText="Modified Date" DataField="EM_MODIFIED_DATE" SortExpression="EM_MODIFIED_DATE" />
                                        ...
                                        <asp:TemplateField HeaderText="Employee Status" HeaderStyle-CssClass="text-nowrap" HeaderStyle-Font-Bold="true">
                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_Emp_status" runat="server" Text='<%#Eval("Emp_status") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Modified By" HeaderStyle-CssClass="text-nowrap" HeaderStyle-Font-Bold="true">
                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_EM_MODIFIED_BY" runat="server" Text='<%#Eval("EM_MODIFIED_BY") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Modified Date" HeaderStyle-CssClass="text-nowrap" HeaderStyle-Font-Bold="true">
                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_EM_MODIFIED_DATE" runat="server" Text='<%#Eval("EM_MODIFIED_DATE") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                                    </Columns>
