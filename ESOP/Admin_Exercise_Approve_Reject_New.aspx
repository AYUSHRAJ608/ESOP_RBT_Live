<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="Admin_Exercise_Approve_Reject_New.aspx.cs" Inherits="ESOP.Admin_Exercise_Approve_Reject_New" %>
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="false" OnPreRender="grdMain_PreRender"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-Width="1%">
                                                            <ItemTemplate>
                                                                <img alt="" style="cursor: pointer" src="assets/img/plus.svg" height="25px" width="25px" onclick="toggleChildGridView(this);" />
                                                                <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                                                    <asp:GridView ID="GrvPendingforApproval" runat="server" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" PageSize="25"
                                                                        CssClass="table" EmptyDataText="No Records Found" DataKeyNames="EETDID,GRANT_ID,EXERCISE_TRAN_ID,vesting_detail_id,ecode"
                                                                        EnableViewState="false" OnRowDataBound="GrvPendingforApproval_RowDataBound">
                                                                         <%--Child GridView columns--%> 
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundField DataField="GRANT_NAME" HeaderText="ESOP Code" HeaderStyle-Width="10%" />
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Grant Price" Visible="true">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblgrant_price" runat="server" Text='<%# Bind("grant_price") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:BoundField DataField="GRANT_FMV_PRICE" HeaderText="Excer FMV Price" HeaderStyle-Width="5%" />
                                                                            <asp:TemplateField HeaderText="No of Options Exercised" Visible="true">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblno_of_exercise" runat="server" Text='<%# Bind("no_of_exercise") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Total Amount reflected">
                                                                                <ItemTemplate>
                                                         ...
                                                         <%--Rest of the main GridView columns--%> 
                                                        <asp:BoundField DataField="ecode" HeaderText="Employee Code" HeaderStyle-Width="5%" />
                                                <asp:BoundField DataField="emp_name" HeaderText="Employee Name" HeaderStyle-Width="6%" />
                                                <asp:BoundField DataField="Total No Of Esop" HeaderText="Total No Of Esop" HeaderStyle-Width="6%" />
                                                <asp:BoundField DataField="Total Amount" HeaderText="Total Amount" HeaderStyle-Width="6%" />
                                               <asp:TemplateField HeaderText="Remark">
                                                ...
                                                <asp:TemplateField HeaderText="Perq Tax Amount">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txt_PerqAmt" runat="server" placeholder="Enter Perq Tax Amount" Width="103px" OnTextChanged="txt_PerqAmt_TextChanged" AutoPostBack="true" AutoCompleteType="Disabled" ></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Total Amount reflected">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTotal_Amount_main" runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Action" HeaderStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <div class="btn-group">
                                                            <asp:Button ID="btnApprove" Text="Approve" runat="server" CausesValidation="false" CommandName="Approve"
                                                                CssClass="btn badge badge-success badge-shadow"></asp:Button>

                                                            <asp:Button ID="btnReject" Text="Reject" runat="server" CommandName="Reject"
                                                                CssClass="btn badge badge-danger badge-shadow"></asp:Button>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                        ...
                                        <asp:UpdatePanel ID="updpnl2" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="GrvApproved" runat="server" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" PageSize="25"
                                                    OnPreRender="GrvApproved_PreRender" AlternatingRowStyle-CssClass="table" EmptyDataText="" AllowPaging="false" AllowSorting="false"
                                                    OnPageIndexChanging="GrvApproved_PageIndexChanging" OnSorting="GrvApproved_Sorting">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="NO_OF_VESTING" HeaderText="Total No of Options" HeaderStyle-Width="10%" />
                                                        <asp:BoundField DataField="perq_tax_amount" HeaderText="Perq Tax Amount" HeaderStyle-Width="10%" />
                                                        <asp:BoundField DataField="total_amount" HeaderText="Total Amount" HeaderStyle-Width="10%" />
