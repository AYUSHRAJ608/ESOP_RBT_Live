<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="vesting-approval-admin.aspx.cs" Inherits="ESOP.vesting_approval_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="main-content" style="padding-top: 55px; padding-left: 40px; padding-right: 10px;">
        ...
        <%--<div style="font-weight: 500"><b>President Grant Approval Summary</b></div>--%>
                    ...
                    <div class="card" style="height: 100%;">
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            ...
                            <ContentTemplate>
                                <div class="card-header">
                                    <h4 class="col-md-12">Vesting Approval List
                        ...
                        <div class="card-body">
                            <ul class="offset-md-4 nav nav-pills" id="myTab3" role="tablist">
                                ...
                                <%--uncommented code by Pallavi on 01/03/2022--%>
                                <li class="nav-item">
                            ...
                            <div class="tab-content" id="myTabContent2">
                                    ...
                                    <div class="table-responsive" style="margin-top: 2px;">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <asp:GridView ID="GrvPendingforApproval" ClientIDMode="static" runat="server" AutoGenerateColumns="False" PageSize="25" ShowHeaderWhenEmpty="false"
                                                    ...
                                                    EmptyDataText="" OnPreRender="GrvPendingforApproval_PreRender">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                        ...
                                                        <asp:BoundField DataField="ECODE" HeaderText="Emp ID" HeaderStyle-Width="10%" />
                                                        <asp:BoundField DataField="EMP_NAME" HeaderText="Emp Name" HeaderStyle-Width="12%" />
                                                        <asp:BoundField DataField="GRANT_NAME" HeaderText="Tranch Code" />
                                                        <asp:BoundField DataField="Grant_Date" HeaderText="Grant Date" DataFormatString="{0:dd-M-yyyy}" HeaderStyle-Width="9%" />
                                                        <asp:BoundField DataField="VESTING_ID" HeaderText="Vest Code" HeaderStyle-Width="5%" />
                                                        <asp:BoundField DataField="Vesting_Date" HeaderText="Vest Date" DataFormatString="{0:dd-MMM-yyyy}" HeaderStyle-Width="9%" />
                                                        <asp:BoundField DataField="no_of_vesting" HeaderText="No. of Options" HeaderStyle-Width="5%" />
                                                        <asp:BoundField DataField="Tranch_Vesting" HeaderText="Tranch Vesting" HeaderStyle-Width="10%" />
                                                        <asp:BoundField HeaderText="Created Date" DataField="CREATION_DATE" SortExpression="CREATION_DATE" />
                                                        <asp:TemplateField HeaderText="Remark">
                                                            <ItemTemplate>
                                                                <div class="remark">

                                                                    <asp:TextBox ID="TxtRemarkPend_Approval" ondrop="return false;" ondrag="return false;" runat="server" placeholder="Enter Remark" Width="90"
                                                        ...
                                                        <asp:TemplateField HeaderText="Action" HeaderStyle-Width="10%">
                                                            <ItemTemplate>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <%--Uncommented code by Pallavi on 28/02/2022--%>
                                        ...
                                        <asp:UpdatePanel ID="upd" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="GrvApproved" runat="server" OnPreRender="GrvApproved_PreRender" ShowHeaderWhenEmpty="false"
                                                    AutoGenerateColumns="false" PageSize="25" class="table dataTable no-footer" EmptyDataText=""
                                                    OnRowCommand="GrvApproved_RowCommand" DataKeyNames="GRANT_ID,V_DETAIL_ID,ECODE,Vesting_ID" Style="width: 100%">
                                                    <Columns>
                                                        <asp:BoundField DataField="ECODE" HeaderText="Employee ID" HeaderStyle-Width="12.5%" />
                                                        <asp:BoundField DataField="EMP_NAME" HeaderText="Employee Name" />
                                                        <asp:BoundField DataField="GRANT_NAME" HeaderText="Tranch Code" />
                                                        <asp:BoundField DataField="Grant_Date" HeaderText="Date of Grant" DataFormatString="{0:dd-M-yyyy}" />
                                                        <asp:BoundField DataField="VESTING_ID" HeaderText="Vest Code" />
                                                        <asp:BoundField DataField="Vesting_Date" HeaderText="Date of Vest" DataFormatString="{0:dd-MMM-yyyy}" />
                                                        <asp:BoundField DataField="no_of_vesting" HeaderText="No. of Options" />
                                                        <asp:BoundField DataField="Tranch_Vesting" HeaderText="Tranch Vesting" />
                                ...
                                <%--<div class="tab-pane fade" id="contact3" role="tabpanel" aria-labelledby="contact-tab3">
                                    <div class="table-responsive" style="margin-top: 30px;">--%>
                                        <div class="tab-pane fade" id="contact3" role="tabpanel" aria-labelledby="profile-tab3">
                                    <div class="table-responsive  width100" style="margin-top: 30px;">
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="GrvReject" runat="server" OnPreRender="GrvReject_PreRender" ShowHeaderWhenEmpty="false"
                                                    AutoGenerateColumns="false" PageSize="25" class="table dataTable no-footer" EmptyDataText="" OnRowCommand="GrvReject_RowCommand"
                                                    DataKeyNames="GRANT_ID,V_DETAIL_ID,ECODE,Vesting_ID" Style="width: 100%">
                                                    <Columns>
    ...
    <script type="text/javascript">
        ...
        prm.add_endRequest(function (sender, e) {
            ...
            $('#ContentPlaceHolder1_GrvPendingforApproval').DataTable({
