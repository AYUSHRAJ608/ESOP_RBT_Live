<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="Admin_SellWindow.aspx.cs" Inherits="ESOP.Admin_SellWindow" %>
                ...
                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="offset-md-1 card-body mr-4">
                            <div class="row" style="margin-top: 55px; margin-left:0;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="Sale.aspx">
                                                <div class="profile-widget-name">
                                                   ...
                                                   <span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="SaleWindowcount" runat="server"></span>Sale Window
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-sm-12 col-lg-4">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="Admin_Sell_Approve_Reject.aspx">
                                                <div class="profile-widget-name">
                                                    <span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="SaleApprovecount" runat="server"></span>Sale Allotment Approve
                                ...
                                <div class="col-12 col-sm-12 col-lg-4">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="Admin_Sell_Approve_Reject_1.aspx">
                                                <div class="profile-widget-name">
                                                    <span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="DisApprovecount" runat="server"></span>Dis Allotment Approve
                                                    <%--<span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="updategrnt" runat="server"></span>Sell Approve--%>
                                                </div>
                                            </a>
                                        </div>
