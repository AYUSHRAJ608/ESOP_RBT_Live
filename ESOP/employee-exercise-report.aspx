<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="employee-exercise-report.aspx.cs" Inherits="ESOP.employee_exercise_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        prm.add_endRequest(function (sender, e) {
            ...
            $('#ContentPlaceHolder1_gvExercise').dataTable({
    ...
    <div class="main-content">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Exercise Reports</li>
            </ol>
        </nav>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 offset-md-3" style="padding-top: 30px;">
                                    <asp:UpdatePanel ID="upd12" runat="server">
                                        <ContentTemplate>
                                            <asp:Button ID="btnFilter" runat="server" Text="Filter" CssClass="btn btn-info btn-lg" OnClick="btnFilter_Click" Style="margin-top: -11%" />
                                            <%--                                            <asp:Button ID="btnExport" runat="server" Text="Export" CssClass="btn btn-info btn-lg" OnClick="btnExport_Click" />--%>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                    ...
                                    <ContentTemplate>
                                        <asp:GridView ID="gvExercise" runat="server" AutoGenerateColumns="False" PageSize="25" ShowHeaderWhenEmpty="false"
                                            class="table table-striped table-hover" DataKeyNames="" EmptyDataText="No Records Found" OnRowDataBound="gvExercise_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="VESTING_DETAIL_CODE" HeaderText="Vesting Name" HeaderStyle-Width="" />
                                                <asp:BoundField DataField="EXERCISE_DATE" HeaderText="Exercise Date" DataFormatString="{0:dd-M-yyyy}" HeaderStyle-Width="" />
                                                <asp:BoundField DataField="PAYMENT_MODE" HeaderText="Payment Mode" HeaderStyle-Width="" />
                                        ...
                                        <asp:BoundField DataField="Vesting_Date" HeaderText="Date of Vest" DataFormatString="{0:dd-M-yyyy}" HeaderStyle-Width="9%" />
