...
namespace ESOP
{
    public partial class Checker_Approve_Reject : System.Web.UI.Page
    {
        ...
        private void bind_hr_all_count()
        {
            ...
            DataSet ds = objbal.get_chcker_all_count(objbo);
            ...
            {
                ViewState["HR_Head"] = ds.Tables[4].Rows[0][0].ToString();
            }
        }
        ...
        private void bind_approval_data_hr()
        {
...

            {
                ...
                DataSet ds = objbal.get_checker_appraval_date(objbo);
        ...
        protected void btn_Approve_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                objbo.status = "APPROVED_BY_CHECKER";
                objbo.proxy = Convert.ToString(Session["Proxy"]);

                status1 = "Approved";
                bool val = objbal.update_status_Checker(objbo);
                ...
                if (val == true)
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        SendMail.Function_SendMail(Convert.ToString(Session["UserName"]), ds.Tables[0].Rows[0]["USERNAME"].ToString(), "Grant", "Grant Approved by Checker", grdpendingapproval.DataKeys[rowIndex].Values[2].ToString(), "", grdpendingapproval.DataKeys[rowIndex].Values[0].ToString(), grdpendingapproval.DataKeys[rowIndex].Values[3].ToString(), "", "", "");
                    }
                }
                bind_approval_data_hr();
                bind_hr_all_count();
                ...
                showmsg.InnerText = "Grant has been approved, sent for HR Head " + ViewState["HR_Head"].ToString() +" approval.";
            }
            catch (Exception ex)
            {
                Common.ErrorLogging(this.Page.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name.ToString(), ex.Message, ex.StackTrace);
        ...
        protected void btn_Reject_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objbo.proxy = Convert.ToString(Session["Proxy"]);
                objbo.status = "REJECTED_BY_CHECKER";
                status1 = "Rejected";
                ...
                if (val == true)
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        SendMail.Function_SendMail(Convert.ToString(Session["UserName"]), ds.Tables[0].Rows[0]["USERNAME"].ToString(), "Grant", "Grant Rejected by Checker", grdpendingapproval.DataKeys[rowIndex].Values[2].ToString(), "", "", grdpendingapproval.DataKeys[rowIndex].Values[3].ToString(), "", "", "");
                    }
                        ...
                        if (checkbox.Checked)
                        {
                            ...
                            if (val == true)
                            {
                                ...
                                if (ds.Tables[0].Rows.Count > 0)
                                {
                                    //SendMail(status1, ds.Tables[0].Rows[0]["USERNAME"].ToString(), ds.Tables[0].Rows[0]["EMAILID"].ToString(), Attachment);
                                    // SendMail(ds.Tables[0].Rows[0]["USERNAME"].ToString(), "Grant Approved by HR");
                                    SendMail.Function_SendMail(Convert.ToString(Session["UserName"]), ds.Tables[0].Rows[0]["USERNAME"].ToString(), "Grant", "Grant Approved by Checker", grdpendingapproval.DataKeys[gvrow.RowIndex].Values[2].ToString(), "", grdpendingapproval.DataKeys[gvrow.RowIndex].Value.ToString(), grdpendingapproval.DataKeys[gvrow.RowIndex].Values[3].ToString(), "", "", ""); ;
                                }
                ...
                foreach (GridViewRow gvrow in grdpendingapproval.Rows)
                {
                    ...
                    if (gvrow.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        if (checkbox.Checked)
                        {
                            ...
                            bool val = objbal.update_rejected_status_Checker(objbo);
                            ...
                            if (val == true)
                            {
                                ...
                                if (ds.Tables[0].Rows.Count > 0)
                                {
                                    //SendMail(status1, ds.Tables[0].Rows[0]["USERNAME"].ToString(), ds.Tables[0].Rows[0]["EMAILID"].ToString(), Attachment);
                                    //SendMail(ds.Tables[0].Rows[0]["USERNAME"].ToString(), "Grant Rejected by HR");
                                    SendMail.Function_SendMail(Convert.ToString(Session["UserName"]), ds.Tables[0].Rows[0]["USERNAME"].ToString(), "Grant", "Grant Rejected by Checker", grdpendingapproval.DataKeys[gvrow.RowIndex].Values[2].ToString(), "", grdpendingapproval.DataKeys[gvrow.RowIndex].Value.ToString(), grdpendingapproval.DataKeys[gvrow.RowIndex].Values[3].ToString(), "", "", "");
                                }
