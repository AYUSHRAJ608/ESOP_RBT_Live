<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="Secretarial_Approvals.aspx.cs" Inherits="ESOP.Secretarial_Approvals" %>
                ...
                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class=" card-body mr-4">
                            <div class="row" style="margin-top: 55px; margin-left: 12%;">
                                <div class="col-12 col-sm-12 col-lg-4">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="Secretarial_Grant_Approve_Reject.aspx">
                                                <div class="profile-widget-name">
                                                    <span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="Grantcount" runat="server"></span>Grant Approvals
                                ...
                                <div class="col-12 col-sm-12 col-lg-4">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="Employee-secretarial.aspx">
                                                <div class="profile-widget-name">
                                                    
                                                   <span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="Exercisecount" runat="server"></span>Exercise Approvals
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-sm-12 col-lg-4">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="Secretarial_Sell_Aapprove_Reject.aspx">
                                                <div class="profile-widget-name">
                                                    <span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="Salecount" runat="server"></span>Sale Approvals
                                                    <%--<span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="updategrnt" runat="server"></span>Sell Approve--%>
                                                </div>
                                            </a>
                                        </div>
