<%@ Page Title="HR Dashboard" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="hr-dashboard.aspx.cs" Inherits="ESOP.hr_dashboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>ESOP-HR Dashboard</title>
    <style>
        .griditem {
    ...
    <div class="sidebar-mini">
        ...
        <div id="app">
            <div class="main-wrapper main-wrapper-1">
                ...
                <div class="main-content" style="padding-top: 60px; padding-left: 40px; padding-right: 10px;">
                    <section class="section">
                        <div class="section-header" style="display: none;">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="section-header-breadcrumb-content">
                                        <h1 style="margin-right: 6px;">Admin Dashboard FY </h1>
