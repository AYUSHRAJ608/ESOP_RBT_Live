<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ESOP.Master" CodeBehind="Add_Existing_Data_New.aspx.cs" Inherits="ESOP.Add_Existing_Data_New" %>
            ...
            if (FileUploadFooter.trim() == "") {
                ...
                if (ext == "xlx" || ext == "xlsx") {
                   <%-- var updateProgress1 = $get("<%= UpdateProgress1.ClientID %>");
                    ...
                    alert("Invalid file, must select a *.xls,xlsx file only.");
                                ...
                                <div class="col-md-4 multidatadiv">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlData" runat="server" CssClass="form-control" AutoPostBack="false">
                                            ...
                                            <asp:ListItem Value="1">Valuation Master</asp:ListItem>
                                            <asp:ListItem Value="2">FMV Master</asp:ListItem>
                                            <asp:ListItem Value="3">Vesting Master</asp:ListItem>
                                            <asp:ListItem Value="4">Grant Creation Master</asp:ListItem>
                                            <asp:ListItem Value="5">Employee Excercise</asp:ListItem>
                                            <asp:ListItem Value="6">Employee Sale</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <button runat="server" id="btnExDown" onserverclick="btnExDown_ServerClick" style="background: none">
