...
namespace ESOP
{
    public partial class Admin_Transaction_History : System.Web.UI.Page
    {
        ...
        protected void GrvGrant_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Audit")
            {
                ...
                objBo.GRANT_ID = Convert.ToInt32(gv1.DataKeys[index].Values[0]);
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "openModalShowGrantAudit();", true);
            }
        }
