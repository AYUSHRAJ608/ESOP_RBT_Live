<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="Tax_Master.aspx.cs" Inherits="ESOP.Tax_Master" %>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="offset-md row mx-auto" style="margin-top: 15px;">
                                        ...
                                        <div class="col-lg-3 offset-md-3" style="margin-top: 7rem !important; margin-left: 32%;">
                            ...
                            <asp:UpdatePanel ID="upd" runat="server">
                                <ContentTemplate>                                   
                                    ...
                                    <asp:GridView ID="grdtax" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="false"
                                        ...
                                        OnRowUpdating="grdtax_RowUpdating" OnPreRender="grdtax_PreRender" OnRowCommand="grdtax_RowCommand"
                                        OnRowCancelingEdit="grdtax_RowCancelingEdit" OnRowDeleting="grdtax_RowDeleting"
                                        class="table">
