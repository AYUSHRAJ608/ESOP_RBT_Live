<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="grants.aspx.cs" Inherits="ESOP.grants" %>
                            ...
                            <div class="row" style="margin-top: 55px;">
                                <div class="col-12 col-sm-12 col-lg-4">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="Grand_Creation.aspx">
                                                <div class="profile-widget-name">Create Grant</div>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-lg-4">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="AdminGrantUpdation.aspx">
                                                <div class="profile-widget-name">

                                                    <span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="updategrnt" runat="server"></span>Update Grant
                                    ...
                                    <div class="card profile-widget" style="height: 65%;">
                                        <div class="profile-widget-header">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="feature-rounded">
                                                        <img alt="image" src="assets/img/refresh (1).png" class="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="profile-widget-description pb-0">
                                            <a href="Grant_Correction.aspx">
                                                <div class="profile-widget-name">
                                                    <span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="countgrnt" runat="server"></span>Correction of Rejected Grant
                                                </div>
                                            </a>
                                        </div>
                                    </div>
