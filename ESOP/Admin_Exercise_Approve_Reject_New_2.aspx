                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderStyle-Width="3%">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Panel ID="pnlOrders" runat="server" Style="display: none" CssClass="table">
                                                                    <%--<asp:UpdatePanel ID="updpnl1" runat="server" UpdateMode="Conditional">
                                                                        <ContentTemplate>--%>
                                                                    <asp:Repeater ID="rptPendingforApproval" runat="server" OnItemDataBound="rptPendingforApproval_ItemDataBound">
                                                                        <HeaderTemplate>
                                                                            <table class="tblcolor" border="1">
                                                                                <tr>
                                                                                    <b>
                                                                                        <td>Employee Code  
                                                                                        </td>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <tr class="tblrowcolor">
                                                                                <td>
                                                                                    <%#DataBinder.Eval(Container,"DataItem.ecode")%>  
                                                                                </td>
                                                                                <td>
                                                                                    <%#DataBinder.Eval(Container,"DataItem.emp_name")%>  
                                                                                </td>
                                                                                <td>
                                                                                    <%#DataBinder.Eval(Container,"DataItem.GRANT_NAME")%>  
                                                                                </td>
                                                                                <td>
                                                                                    <%#DataBinder.Eval(Container,"DataItem.createddate")%>  
                                                                                </td>
                                                                                <td>
                                                                                    <%#DataBinder.Eval(Container,"DataItem.VESTING_DATE")%>  
                                                                                </td>
                                                                                <td>
                                                                                    <%#DataBinder.Eval(Container,"DataItem.grant_price")%>  
                                                                                </td>
                                                                                <td>
                                                                                    <%#DataBinder.Eval(Container,"DataItem.GRANT_FMV_PRICE")%>  
                                                                                </td>
                                                                                <td>
                                                                                    <%#DataBinder.Eval(Container,"DataItem.no_of_exercise")%>  
                                                                                </td>
                                                                                <td>
                                                                                    <%#DataBinder.Eval(Container,"DataItem.NO_OF_VESTING")%>  
                                                                                </td>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txt_PerqAmt" runat="server" placeholder="Enter Perq Tax Amount" Width="103px" AutoPostBack="true"></asp:TextBox>
                                                                                </td>
                                                                                <td>
