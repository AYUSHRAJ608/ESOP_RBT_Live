<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Sell_Approve_Reject_1.aspx.cs" Inherits="ESOP.Admin_Sell_Approve_Reject_1" MasterPageFile="~/ESOP.Master"%>
    ...
    <div class="main-content">
        ...
        <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sale Approve</li>
            </ol>
        </nav>
                ...
                <div class="col-12">
                    <div class="card" style="height: 100%;">
                        <div class="card-header">
                            <h4>Admin Sale Approval Summary</h4>
                                ...
                                <div class="tab-pane fade active show" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                                    <div class="table-responsive" style="margin-top: 5px;">
                                        ...
                                        <asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="false" OnPreRender="grdMain_PreRender"
                                            CssClass="table table-bordered simple-tree-table treetablecss" DataKeyNames="ECODE,SALE_OFFER_FILE_PATH,SALE_DECLARATION_FILE_PATH,SALE_TRANSACTION_RECEIPT_FILE_PATH" OnRowDataBound="grdMain_RowDataBound"
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="GrvReject" runat="server" OnPreRender="GrvReject_PreRender" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" PageSize="25"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="sale_date" HeaderText="Sale Date" HeaderStyle-Width="10%" SortExpression="sale_date" DataFormatString="{0:dd-M-yyyy}" />
