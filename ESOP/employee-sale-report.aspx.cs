...
namespace ESOP
{
    public partial class employee_sale_report : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                GET_EMPLOYEE_SALE_REPORT();
            }

        }
        public void GET_EMPLOYEE_SALE_REPORT()
        {
            try
            {
                ...
                ds = objBAL.GET_EMPLOYEE_SALE_REPORT(objBO);
        ...
        protected void btnexcelExport_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //string filename = "EMPLOYEE_SALE_REPORT_" + Convert.ToString(Session["ECODE"]) + "_" + DateTime.Now.ToString("yyyyMMdd_HHmmss");
            ...
            Response.Charset = "";
            string FileName = "EMPLOYEE_SALE_REPORT" + "_" + DateTime.Now.ToString("ddMMyyyy_HHmmss");
