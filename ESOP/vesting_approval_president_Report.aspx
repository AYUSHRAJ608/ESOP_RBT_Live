<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="vesting_approval_president_Report.aspx.cs" Inherits="ESOP.vesting_approval_president_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="main-content">
        <div style="font-weight: 500; display: none" runat="server" id="div">President Vesting Approval Summary</div>
        <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" runat="server" id="li">President Vesting Approval</li>
            </ol>
        </nav>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>President Vesting Approval Summary</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <asp:UpdatePanel ID="upd" runat="server" UpdateMode="Conditional">
                                    ...
                                    <ContentTemplate>
                                        <asp:GridView ID="GrvApproved" runat="server" OnPreRender="GrvApproved_PreRender" ShowHeaderWhenEmpty="false"
                                            AutoGenerateColumns="false" PageSize="25" class="table" EmptyDataText="No Records Found">
                                            <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-Width="1%" HeaderText="SrNo">
                                                ...
                                                <asp:BoundField DataField="ADMIN_VESTING_REMARK" HeaderText="Admin Remark" />
                                                <asp:BoundField DataField="PR_VESTING_REMARK" HeaderText="President Remark" />
                                                <asp:BoundField DataField="Proxy" HeaderText="Proxy" />
