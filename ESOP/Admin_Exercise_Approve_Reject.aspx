<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="Admin_Exercise_Approve_Reject.aspx.cs" Inherits="ESOP.Admin_Exercise_Approve_Reject" %>
    ...
    <div class="main-content">
        ...
        <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="Admin_SellWindow.aspx">Sell</a></li>
                <li class="breadcrumb-item active" aria-current="page">Sell Approve</li>
            </ol>
        </nav>
                    ...
                    <div class="card" style="height: 100%;">
                        <div class="card-header">
                            ...
                            <div class="offset-md-7 buttons" style="margin-left: 56.333333%" id="showhidebtn">
                                <asp:Button ID="btn_BulkApprove" runat="server" OnClick="btn_bulkApprove_Click" CausesValidation="false"
                                    Text="Bulk Approve" CssClass="btn badge badge-success badge-shadow" Visible="false"></asp:Button>
                                <asp:Button ID="btn_BulkReject" runat="server" OnClick="btn_bulkReject_Click" OnClientClick="bulkvalidateCheckBoxesreject" CausesValidation="false"
                                    Text="Bulk Reject" CssClass="btn badge badge-danger badge-shadow" Visible="false"></asp:Button>
                                <%--Visible="false"--%>
                            </div>
                        ...
                        <div class="card-body">
                            <ul class="offset-md-4 nav nav-pills" id="myTab3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab3" data-toggle="tab" href="#contact3" role="tab" aria-controls="contact" aria-selected="false">Rejected</a> <%--style="display: none;"--%>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade active show" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                                    <div class="table-responsive" style="margin-top: 5px;">
                                        ...
                                        <asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="false" OnPreRender="grdMain_PreRender"
                                            CssClass="table table-bordered simple-tree-table treetablecss" DataKeyNames="ECODE" OnRowDataBound="GrvPFADB"
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="GrvReject" runat="server" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" PageSize="25"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="emp_name" HeaderText="Employee Name" HeaderStyle-Width="12%" />
                                                        <%--<asp:BoundField DataField="GRANT_NAME" HeaderText="ESOP Code" />--%>
                                                        <%--<asp:BoundField DataField="createddate" HeaderText="Exercise Date" DataFormatString="{0:dd-M-yyyy}" HeaderStyle-Width="9%" />--%>
                                                        <asp:BoundField DataField="sale_date" HeaderText="Sell Date" HeaderStyle-Width="5%" />
                                                        <asp:BoundField DataField="sale_fmv_price" HeaderText="Sell Fmv Price" HeaderStyle-Width="5%" />
                                                        <%--<asp:BoundField DataField="grant_price" HeaderText="Grant Price" HeaderStyle-Width="5%" />--%>
                                                        <asp:BoundField DataField="no_of_sale" HeaderText="No of Sell" HeaderStyle-Width="5%" />
                                                        <asp:BoundField DataField="total_amount" HeaderText="Total Amount Payable" HeaderStyle-Width="10%" />
