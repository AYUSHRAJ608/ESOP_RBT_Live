<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="approval.aspx.cs" Inherits="ESOP.approval" %>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        ...
                        <%-- <div class="offset-md-4 card-body mr-6">
                            <div class="row" style="margin-top: 55px; margin-right: 31%">
                                <div class="col-12 col-sm-12 col-lg-4">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="PresidentsGrantApproval.aspx">
                                                <div class="profile-widget-name">  <span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="grantapproval" runat="server"></span>Grant Approval</div>
                                            </a>
                                        </div>
                                    </div>
                                </div>--%>
                        <div class="offset-md-1 card-body mr-4">
                            <div class="row" style="margin-top: 55px; margin-left: 34%;">
                                <div class="col-12 col-sm-12 col-lg-4">
                                    <div class="card profile-widget" style="height: 65%; align-content: center;">
                                        <div class="profile-widget-header">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="feature-rounded">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="vesting-approval-president.aspx">
                                                <div class="profile-widget-name"><span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="vestingapproval" runat="server"></span>Vesting Approval </div>
                                            </a>
                                        </div>
                                    </div>
                                </div>
