<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="admin-dashboard.aspx.cs" Inherits="ESOP.admin_dashboard" %>
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="gvParent" runat="server" AutoGenerateColumns="false"
                                                    ...
                                                    <Columns>
                                                                                        ...
                                                                                        <asp:GridView ID="gvChildInner" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered simple-tree-table"
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="Exercised" HeaderStyle-Font-Bold="true" FooterStyle-Font-Bold="true"
                                                                                                    ...
                                                                                                    <asp:TemplateField HeaderText="EXERCISE DATE" HeaderStyle-Font-Bold="true" FooterStyle-Font-Bold="true"
                                                                                                        HeaderStyle-Width="8%">
                                                                                                        <ItemTemplate>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="SALE DATE" HeaderStyle-Font-Bold="true" FooterStyle-Font-Bold="true"
                                                                                                        HeaderStyle-Width="8%">
                                                                                                        <ItemTemplate>
                                                                                                            <asp:Label ID="lblSALE_DATE" runat="server" Text='<%#Eval("SALE_DATE") %>' />
                                                                                                        </ItemTemplate>
                                                                                                    </asp:TemplateField>                                                                                                
                                                                                                    <%--Replaced SALE_DATE with LAV--%>
                                                        ...
                                                        <asp:BoundField DataField="SALE" HeaderStyle-Font-Bold="true" HeaderText="Sell" HeaderStyle-Width="9%">
                                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="True" />
                                                        </asp:BoundField>
