<%@  Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="employee-exercise.aspx.cs" Inherits="ESOP.employee_exercise" %>
    ...
    <script>
        function Clear() {
            if (document.getElementById('customRadioInline4').checked) {
				...
				<%--alert('hii')
				var AsyncFileUpload = $get("<%=fuNEFT1.ClientID%>");
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <fieldset>
                                                ...
                                                <asp:TemplateField HeaderText="No. of options Exercised" HeaderStyle-Width="15%">
                                                    <ItemTemplate>
                                                        <div class="remark" style="text-align: left;">
                                                            <%--<asp:TextBox ID="txtTotOptions" runat="server" Text='<%# Eval("Total_no_of_Options") %>' CssClass="form-control"
																Enabled="false"></asp:TextBox>
															<asp:Label ID="lblTotOptions" runat="server" Text='<%# Eval("Total_no_of_Options") %>'></asp:Label>--%>
                                ...
                                <div class="row" style="margin-top: 15px;">
                                    ...
                                    <div class="table-responsive">
									   ...
									   <thead>
										  <tr>
											 <th>Vesting Cycle</th>
											 <th>Exercise Consideration</th>
											 <th>Current Taxable Income</th>
											 <th>(FMV-Grant price)*Options Exercised</th>
											 <th>Revised Taxable Income</th>
											 <th>Tax Per Option</th>
											 <th>Perq Tax Amount</th>
											 <th>Total Amount</th>
										  </tr>
									   </thead> 
									   <tbody>
										  ...
										  <tr>
											 ...
											 <td></td>
											 <td></td>
											 <td style="color:#000000c2;font-weight: 600;">Total</td>
											 <td>6,31,423</td>
										  </tr>
									   </tbody>
									</table>--%>
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="gvExerciseCal" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="Revised_Taxable_Income" HeaderText="Revised Taxable Income" HeaderStyle-Width="12%" />
                                                        <%--Rename Tax Per Option as Tax Slab by Pallavi on 01/03/2022--%>
                                                        <asp:BoundField DataField="Tax_Per_Option" HeaderText="Tax Slab" HeaderStyle-Width="8%" />
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 offset-lg-5">
                                        <asp:Button ID="btnSubmit1" type="button" runat="server" Style="margin-bottom: 30px" class="btn btn-info btn-lg" Text="Submit" OnClick="btnSubmit1_Click"></asp:Button>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="custom-control custom-radio custom-control-inline" style="margin-bottom: 15px;">
                                                    <input type="radio" id="customRadioInline4" name="customRadioInline3" class="custom-control-input" value="Cheque" onclick="Clear();" <%= this.inputtypeCheque %>>
                                            ...
                                            <div class="col-lg-5 custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="customRadioInline3" name="customRadioInline3" class="custom-control-input" value="neft" onclick="Clear();" <%= this.inputtypeNEFT %>>
                                            ...
                                            <div class="col-lg-3 custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="customRadioInline2" name="customRadioInline3" class="custom-control-input" value="loan" onclick="Clear();" <%= this.inputtypeLoan %>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <asp:UpdatePanel ID="Updatepanel5" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlChequeBankName" runat="server" class="form-control" AutoPostBack="true"
                                    ...
                                    <%--<div class="col-lg-3 col-md-12 col-sn-12 form-group filter hdpe Cheque" style="padding-left: 35px; display:none" >
										<label>Cancel Cheque Screenshot</label>
										<div class="letterview" style="width: 130px; display: none;" id="divChequeFresh">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <asp:UpdatePanel ID="Updatepanel38" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlLoanMarginMode" runat="server" class="form-control" onchange="dropchange()" OnSelectedIndexChanged="ddlLoanMarginMode_SelectedIndexChanged" AutoPostBack="true">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <asp:UpdatePanel ID="Updatepanel25" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlChequeBankNameLoan" runat="server" class="form-control" AutoPostBack="true"
                                ...
                                <%--<div class="col-lg-3 col-md-12 col-sn-12 form-group filter hdpe Loan_Cheque" style="padding-left: 35px;display:none">
									<label>Cancel Cheque Screenshot</label>
									<div class="letterview" style="width: 130px; display: none;" id="divChequeFreshLoan">
										<figure class="snip0013">
											<img src="assets/img/Cancelled-Cheque.jpg" width="130">
											<a href="img/doc.doc" download="">
												<asp:UpdatePanel ID="Updatepanel30" runat="server">
													<ContentTemplate>
														<asp:LinkButton ID="lnkChequeDownloadLoan" runat="server" Text="Download" OnClick="lnkChequeDownloadLoan_Click">
																<p><i class="fas fa-download"></i>Download</p>
														</asp:LinkButton>
													</ContentTemplate>
													<Triggers>
														<asp:PostBackTrigger ControlID="lnkChequeDownloadLoan" />
													</Triggers>
												</asp:UpdatePanel>
											</a>
										</figure>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <asp:UpdatePanel ID="Updatepanel32" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlNEFTBankNameLoan" runat="server" class="form-control" AutoPostBack="true"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <asp:UpdatePanel ID="Updatepanel14" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlOtherSecurity" runat="server" class="form-control" AutoPostBack="true"
                                                ...
                                                <ContentTemplate>
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                            ...
                                                            Display="None" CssClass="validation" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                        <%--<asp:DropDownList ID="ddlOtherMemberType" runat="server" class="form-control">
														...
														<asp:RequiredFieldValidator ID="rfvddlOtherMemberType" runat="server"
															ErrorMessage="Please select member type" ControlToValidate="ddlOtherMemberType" ValidationGroup="Add" ForeColor="Red" InitialValue="0"
															Display="None" CssClass="validation" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                                </ContentTemplate>
                                                <Triggers>
                                                    <asp:AsyncPostBackTrigger ControlID="ddlOtherSecurity" />
                                    ...
                                    <ContentTemplate>
                                        <div class="row">
                                            <div class="col-md-6 text-right">
                                                ...
                                                <asp:Button ID="btnimport" CssClass="btn btn-info btn-lg" Style="margin-bottom: 15px;" runat="server" Text="Preview" ValidationGroup="Add"
                        ...
                        <div class="modal-body" style="padding-left: 15px; padding-right: 15px;">
                            <fieldset style="margin-bottom: 0px; padding-block-end: 0px;">
                                ...
                                <div class="row popRow">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 neft" style="padding-right: 5px; padding-left: 17px;">
                                        <div class="form-group">
                                            <%--<label class="pops">HDFC0001212</label>--%>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 neft" style="padding-right: 5px; padding-left: 17px;">
                                        <div class="form-group">
                                            <%--<label class="pops">02154542112</label>--%>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 neft" style="padding-right: 5px; padding-left: 17px;">
                                        <div class="form-group">
                                            <%--<label class="pops">2020-11-08</label>--%>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 loan" style="padding-right: 5px; padding-left: 17px;">
                                        <div class="form-group">
                                            <%--<label class="pops">HDFC Bank</label>--%>
                            ...
                            <%--added for preview docs--%>
                            <%--<fieldset style="margin-bottom: 0px; padding-block-end: 0px;" id="f1" runat="server">
								<legend style="width: 15%; font-size: 1rem;">Cancel Cheque Screenshot: </legend>
								<asp:Image ID="Image1" ImageUrl="" runat="server" CssClass="img" />
							</fieldset>--%>
...
if (prm != null) {
    ...
    <script type="text/javascript">
        function Change_Session_Value() {
		    ...
		    //alert('<%=Session["Emp_Exercise_Session"] %>');
		    // __doPostBack('btnimport', 'OnClick');
		}
    </script>
</asp:Content>
