<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="reports.aspx.cs" Inherits="ESOP.reports" %>
                ...
                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        ...
                        <asp:UpdatePanel ID="upd" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <div>
                                    <asp:Button ID="dataexcel" runat="server" Text="Export to Excel" class="btn btn-info btn-lg all" Style="text-align: left" OnClick="dataexcel_Click" />
                            ...
                            <Triggers>
                                ...
                                <asp:PostBackTrigger ControlID="dataexcel" />
                            </Triggers>
                        </asp:UpdatePanel>
                        <div class="card-body">
                            <div class="row" style="margin-top: 55px !important; margin: 17px;">
                                <div class="col-2">
                                ...
                                <div class="col-2">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="exercise-report.aspx">
                                                <div class="profile-widget-name">
                                                    <%-- <span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="excisereport" runat="server"></span>--%>Exercise Report
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="sale-report.aspx">
                                                <div class="profile-widget-name">
                                                    <%-- <span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="adminsellreport" runat="server"></span>--%>
                                                    Sale Allotment Report
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-2">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="Dis_Allotment_Reports.aspx">
                                                <div class="profile-widget-name">
                                                    Dis Allotment Report
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-2">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="ESOP_Quarterly_Report.aspx">
                                                <div class="profile-widget-name">
                                                    ESOP summary Report
                                                </div>
                                            </a>
                                ...
                                <div class="col-2">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="ESOP_Quarterly_Report.aspx">
                                                <div class="profile-widget-name">
                                                    ESOP Bands wise summary Report
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-2">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="ESOP_Status_Report.aspx">
                                                <div class="profile-widget-name">
                                                    ESOP Status Report
                                                </div>
                                            </a>
                                ...
                                <%--<div class="col">
                                    <div class="card profile-widget" style="height: 65%;">
                                        ...
                                        <div class="profile-widget-description pb-0">
                                            <a href="Audit.aspx">
                                                <div class="profile-widget-name">Audit trail</div>
                                            </a>
                                        </div>
                                    </div>
                                </div>--%>
