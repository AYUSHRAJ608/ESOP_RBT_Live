<%@ Page Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true"  CodeBehind="Checker_Approvals.aspx.cs" Inherits="ESOP.Checker_Approvals" %>
	...
	<div class="main-content">
		<nav aria-label="breadcrumb" >
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Checker Aprrovals</li>
				...
				<div class="col-lg-12 col-md-12 col-12 col-sm-12">
					<div class="card">
						<div class="card-header">
							<h4>Checker Aprrovals</h4>
						</div>
						<div class="offset-md-2 card-body mr-4">
							<div class="offset-md-2 row" style="margin-top: 55px;">
								<div class="col-12 col-sm-12 col-lg-4">
									<div class="card profile-widget" style="height: 65%;">
										...
										<div class="profile-widget-description pb-0">
											<a href="Checker_Approve_Reject.aspx">
												<div class="profile-widget-name">
												   <span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="GrantApprovecount" runat="server"></span>Grant Approval
												</div>
											</a>
										</div>
									</div>
								...
								<div class="col-12 col-sm-12 col-lg-4">
									<div class="card profile-widget" style="height: 65%;">
										...
										<div class="profile-widget-description pb-0">
											<a href="Checker_Lapse_Approve_Reject.aspx">
												<div class="profile-widget-name">
													<span class="notification-count bg-info" style="color: white; padding: 4px 7px; font-size: 16px; padding-top: 7px;" id="LapseApprovecount" runat="server"></span>Lapse Approval
