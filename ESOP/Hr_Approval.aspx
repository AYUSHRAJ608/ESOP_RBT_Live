<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="Hr_Approval.aspx.cs" Inherits="ESOP.Hr_Approval" EnableEventValidation="false" %>
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <asp:GridView ID="grdpendingapproval" runat="server" OnPreRender="grdpendingapproval_PreRender" ShowHeaderWhenEmpty="false"
                                                    AutoGenerateColumns="False" class="table" DataKeyNames="GRANT_ID,ecode,GRANT_NAME,fmv_price,emp_name" OnRowCommand="grdpendingapproval_RowCommand">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
