<%@ Page Title="" Language="C#" MasterPageFile="~/ESOP.Master" AutoEventWireup="true" CodeBehind="Grand_Creation_Append_Override.aspx.cs" Inherits="ESOP.Grand_Creation_Append_Override" %>
                            ...
                            <div class="row" style="margin-top: 15px;">
                                ...
                                <div class="col-lg-3 offset-md-5 mt-5">
                                    ...
                                    <asp:UpdatePanel ID="UP_submit" runat="server">
                                        <ContentTemplate>
                                            <%--<a href="#" class="btn btn-info btn-lg all" id="btnimport">Save Grant</a>--%>
                                            <%--<asp:Button ID="btnSaveGrant" runat="server" Text="Save Grant" OnClick="btnSaveGrant_Click" OnClientClick="Show_Div();" class="btn btn-info btn-lg all" />--%>
                                            ...
                                            <%--class="btn btn-info btn-lg all1"--%>
                                        </ContentTemplate>
                                        <Triggers>
